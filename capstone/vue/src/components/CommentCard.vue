    ...
    <b-card class="comments-card">
      <b-card-header class="font-weight-bold">
        ...
        >
          <table>
            <td>
              <b-avatar
                :variant="commenter.username == isAdmin ? 'danger' : 'primary'"
              >
              </b-avatar>
            </td>
            <td>
      ...
      <b-card-body class="body">
        ...
        <b-form @submit.stop.prevent="onSubmit">
          ...
          >
          <b-button v-show="showEdit" type="submit" variant="primary"
            >Submit</b-button
          >
          <br />
        </b-form>
        ...
        <b-button-group>
          <b-button
            ...
            v-show="
              ...
              $store.state.user.userId == item.commenterId
            "
          >
...
export default {
  ...
  mounted() {
    ...
    userService.GetUser(this.item.commenterId).then((response) => {
